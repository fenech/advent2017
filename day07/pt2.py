s = """fjkfpm (69) -> kohxzh, liwvq, eqkio, xvoyybs
dsiixv (52)
fhimhm (66)
mdlubuq (73)
ulobwyb (41)
...
def get_weight(name):
    ...
    child_weights = list(map(get_weight, children))
    if len(set(child_weights)) > 1:
        print("uneven weights at {}".format(name))
        for name, weight in zip(children, child_weights):
            print("{} ({}): {}".format(name, weight, tree[name]['weight']))
